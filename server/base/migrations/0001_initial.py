# Generated by Django 3.2.3 on 2021-05-16 13:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='/placeholder.png', null=True, upload_to=base.models.upload_picture)),
                ('category', models.CharField(blank=True, help_text='Please enter any one category listed as: GurungMagarRaiLimbuTamangNewarMenChildren', max_length=100, null=True)),
                ('size', models.CharField(blank=True, help_text='Enter the available size seperated by comma ie , ', max_length=200, null=True)),
